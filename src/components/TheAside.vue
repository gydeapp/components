<template>
  ...
  <aside
    :class="{ '-translate-x-full': !isActiveAside }"
    class="fixed top-0 left-0 bottom-0 z-50 w-[296px] transform bg-[#2C2C2C] transition duration-200 ease-in-out lg:block lg:w-[calc((100vw-var(--max-container-width))/2+var(--max-aside-content-width))] lg:translate-x-0"
  >
    <div class="ml-auto px-5 lg:mr-[72px] lg:w-[220px] lg:px-0 lg:pl-5">
      <the-header-container class="mb-9">
...
import TheHeaderContainer from './TheHeaderContainer.vue'
